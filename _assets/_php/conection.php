<?php
	...
	if (mysqli_connect_errno()){
		...
		// send_email_erro($email_sender, $email_smtp, $pass_smtp, "Erro de script", $get_erro, "tentativa de CONEXAO MYSQLI", "Conection");
	...
	class Conexao {
		...
		public static function getInstance() {
			try{
				...
				// informe o erro em nosso email
				// send_email_erro($email_sender, $email_smtp, $pass_smtp, "Erro de script", $get_erro_pdo, "tentativa de CONEXAO PDO", "Conection");
				header('location:error.php');
			}
		}
	}
